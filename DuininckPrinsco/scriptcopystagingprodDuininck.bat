...
ECHO whenever sqlerror exit | sqlplus /@hraj_oracle @c:\AutoMated_DataLoad_Jobs\test\DuininckPrinsco\scriptcopystagingprodDuininck.sql  > c:\AutoMated_DataLoad_Jobs\TEST\DuininckPrinsco\LOG\Duininck.txt
