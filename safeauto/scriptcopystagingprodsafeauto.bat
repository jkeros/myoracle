...
ECHO whenever sqlerror exit | sqlplus /@hraj_oracle @c:\AutoMated_DataLoad_Jobs\test\safeauto\scriptcopystagingprodsafeauto.sql  > c:\AutoMated_DataLoad_Jobs\TEST\safeauto\LOG\safeauto.txt
